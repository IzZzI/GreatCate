...
public class CategoryGridViewAdapter extends BaseAdapter
{
	...
	{ R.drawable.category_homecook_pressed, R.drawable.category_quick_pressed,
			R.drawable.category_creat_pressed, R.drawable.category_vegetable_pressed,
			R.drawable.category_clod_dish_pressed, R.drawable.category_bake_pressed,
			R.drawable.category_noodle_pressed, R.drawable.category_soup_pressed,
			R.drawable.category_seasoner_pressedl };
