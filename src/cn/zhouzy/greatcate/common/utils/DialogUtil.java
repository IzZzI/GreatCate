...
public class DialogUtil
{
	...
	public static BaseDialogFragment showBaseDialog(Context context, boolean cancelable,
			String leftButtonText, String rightButtonText, OnClickListener rightButtonClickListener,
			String titleTxt, String hintMsg)
	{
		BaseDialogFragment newFragment = new BaseDialogFragment(cancelable, leftButtonText,
				rightButtonText, rightButtonClickListener, titleTxt, hintMsg);
	...
	{
		BaseDialogFragment newFragment = new BaseDialogFragment(cancelable, null, null,
